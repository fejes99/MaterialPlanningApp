  ...
  return (
    <>
      ...
      <Modal show={openModal} onClose={onCloseModal}>
        <Modal.Header>Dodaj zahtev za nabavku</Modal.Header>
        <Modal.Body>
          <div>
                  ...
                  <div key={index} className='flex items-center space-x-4 mb-2 rounded-lg'>
                    ...
                    <div className='flex-auto w-24'>
                      <TextInput
                        ...
                        onChange={(event) =>
                          handleMaterialChange(index, 'materialCount', parseInt(event.target.value))
                        }
                        required
                      />
                    </div>
        ...
        <Modal.Footer>
          <div className='w-full'>
            <Button color='blue' onClick={handleCreatePurchaseRequest}>
              Dodaj proizvod
            </Button>
          </div>
        </Modal.Footer>
...
export default PurchaseRequestAddModal;
